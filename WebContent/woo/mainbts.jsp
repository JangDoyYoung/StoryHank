...
<div id="main">
	...
	<div id="logoSection">
		<img alt="" src="btsimage/bts5.jpg" style="width: 1500px; height: 1500px;"/>
	</div>
	<div id="menuSection">
		<ul>
			<li onmouseover="anim('about')" onclick="location.href='about1.jsp'">
				<div id="about" class="menu">
					ABOU
					<div class="rotate">T</div>
				</div>
			</li>	
			<li onmouseover="anim('video')" onclick="window.open('MV1.html');">
			...
			<li onmouseover="anim('photo')" onclick="location.href='photo1.jsp'">
