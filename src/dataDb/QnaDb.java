...
public class QnaDb {
	...
	{
		String sql="insert into qna (num,nickname,title,content,write_date) values (seq_mini.nextval,?,?,?,sysdate)";
	...
	public boolean replyOk(String num)
	{
		boolean r=false;

		String sql="select recontent from qna where num=?";
